...
rings = {
    '1':[[5,6,2,3,4,12],[13,14,7,8,9,10,11,30,29],[21,28,27,15,16,32,31,23,22],[17,20,26,25,24,18],[19]],
    '2':[[6,7,8,3,1],[5,14,15,9,4],[13,27,16,10,12],[29,28,26,32,11],[21,20,25,31,30],[17,19,24,23,22],[18]],
}
    ...
    for ss in marco_data[array].keys():
        ...
        for in_size in [1]:
            ...
            for ichan in range(nchans):
                ...
                ncombs = 1
                all_chans_in = [rings[str(ichan+1)][3][0]]
                all_chans_in = [[i-1 for i in all_chans_in]]
                print(all_chans_in)
            ...
            axs[2].grid(True)
            plt.savefig('_'.join(['plots/eval_inference_mean',ss,array,str(in_size),'.png']))
            plt.close()
            ...
            plt.colorbar()
            plt.savefig('_'.join(['plots/eval_inference_mean_fft_error',ss,array,str(in_size),'.png']))
            plt.close()
